...
<div class="admin-wide-container mt-5 mb-5">
    <div class="cosmic-form-wrapper mx-auto">
        ...
        <div class="cosmic-title-section text-center mb-5 border-0">
            <h2 class="cosmic-main-title text-primary-cosmic">🚀 신규 행성 탐색 (도서 등록)</h2>
            <p class="cosmic-subtitle-text">우주 연합 지식 베이스에 새로운 데이터를 기록합니다.</p>
        </div>
        ...
        <form id="bookForm" action="${pageContext.request.contextPath}/book/insert" method="POST">
            ...
            <div class="form-actions-cosmic">
                <button type="submit" class="btn-confirm-cosmic">지식 베이스에 추가</button>
                <button type="button" class="btn-cancel-cosmic" onclick="location.href='${pageContext.request.contextPath}/book/list'">탐사 취소</button>
            </div>
